...
from diwan_signature.dependency_injection import get_service_provider
...
def cmd_serve_api(args: argparse.Namespace) -> int:
    ...
    from diwan_signature.web.fastapi_app.app import create_app
...
def cmd_serve_flask(args: argparse.Namespace) -> int:
    try:
        from diwan_signature.web.flask_app.app import create_app
    except ImportError as ex:
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Diwan Signature CLI for printer automation.")
