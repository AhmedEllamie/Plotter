...
from diwan_signature.domain.printer_settings import PrinterSettings
from diwan_signature.infrastructure.stores.request_log_store import RequestLogStore
from diwan_signature.services.approval.mock_approval_service import MockApprovalService
from diwan_signature.services.print_approval.print_approval_service import PrintApprovalService
from diwan_signature.services.printer.printer_service import PrinterService
...
def _load_default_config() -> dict[str, Any]:
    # Repo root is the parent of the `diwan_signature` package folder.
